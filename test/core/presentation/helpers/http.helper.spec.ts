...
describe('HttpHelpers', () => {
  ...
  describe('notFoundError [status code = 404]', () => {
    it('should be able to return HttpResponse with status code equals 404 when data is not found', () => {
      const fakeError = new Error('fake_error')
